...
class ModelFree(TagCategory):
    ...
    def __init__(self, sf):
        ...
        self.add(key='AtomType',            tag_name='Atom_type',                   var_name='atom_types',          format='float')
        self.add(key='AtomIsotopeNumber',   tag_name='Atom_isotope_number',         var_name='isotope',             format='float')
