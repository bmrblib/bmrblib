...
class ModelFreeList(TagCategoryFree):
    ...
    def __init__(self, sf):
        ...
        # Add the tag info.
        self.add(key='ModelFreeListID',               tag_name='id',                            var_name='count_str')
        ...
        self.add(key='GlobalChiSquaredFitVal',        tag_name='Global_chi_squared_fit_val',    var_name='global_chi2')
...
class ModelFree(TagCategory):
    ...
    def __init__(self, sf):
        ...
        self.add(key='S2ValErr',            tag_name='S2_value_fit_error',          var_name='s2_err')
        self.add(key='S2fVal',              tag_name='S2f_value',                   var_name='s2f')
        ...
        self.add(key='TauFValErr',          tag_name='Tau_f_value_fit_error',       var_name='tf_err')
        self.add(key='TauSVal',             tag_name='Tau_s_value',                 var_name='ts')
        self.add(key='TauSValErr',          tag_name='Tau_s_value_fit_error',       var_name='ts_err')
