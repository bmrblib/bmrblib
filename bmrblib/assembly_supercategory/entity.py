...
class Entity(TagCategoryFree):
    ...
    def __init__(self, sf):
        ...
        self.add(key='FormulaWeight',                   var_name='formula_weight',                  format='float')
        self.add(key='FormulaWeightExptl',              var_name='formula_weight_exptl',            format='float')
        self.add(key='FormulaWeightExptlMeth',          var_name='formula_weight_exptl_meth',       format='str')
