...
class HeteronuclT2Saveframe(RelaxSaveframe):
    ...
    def add(self, sample_cond_list_id=None, sample_cond_list_label='$conditions_1', frq=None, details=None, assembly_atom_ids=None, entity_assembly_ids=None, entity_ids=None, res_nums=None, seq_id=None, res_names=None, atom_names=None, atom_types=None, isotope=None, data=None, errors=None):
        ...
        # Check the ID info.
        no_missing(entity_ids, 'entity ID numbers of the ' + repr(int(frq*1e-6)) + ' MHz R2 data')
        no_missing(res_nums, 'residue numbers of the ' + repr(int(frq*1e-6)) + ' MHz R2 data')
        no_missing(res_names, 'residue names of the ' + repr(int(frq*1e-6)) + ' MHz R2 data')
        no_missing(atom_names, 'atom names of the ' + repr(int(frq*1e-6)) + ' MHz R2 data')
