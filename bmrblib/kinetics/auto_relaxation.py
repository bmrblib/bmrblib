...
class AutoRelaxation(Rx):
    ...
    def __init__(self, sf):
        ...
        self.add(key='Val',                     tag_name='Auto_relaxation_val',     var_name='data')
        self.add(key='ValErr',                  tag_name='Auto_relaxation_val_err', var_name='errors')
        self.add(key='RexVal',                  tag_name='Rex_val',                 var_name='rex_val')
        self.add(key='RexErr',                  tag_name='Rex_err',                 var_name='rex_err')
