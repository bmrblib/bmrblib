...
class HeteronuclT1Saveframe(RelaxSaveframe):
    ...
    def add_tag_categories(self):
        ...
        self.tag_categories.append(HeteronuclT1List(self))
        self.tag_categories.append(HeteronuclT1Experiment(self))
        self.tag_categories.append(HeteronuclT1Software(self))
        self.tag_categories.append(T1(self))
...
class HeteronuclT1List(HeteronuclRxList):
    ...
    def __init__(self, sf):
        ...
        # Add the tag info.
        self.add(key='HeteronuclT1ListID',          tag_name='id',                          var_name='count_str',               format='int')
        ...
        self.add(key='T1CoherenceType',             tag_name='T1_coherence_type',           var_name='coherence',               default='Nz')
        self.add(key='T1ValUnits',                  tag_name='T1_value_units',              var_name='units',                   default='1/s')
