...
class HeteronuclNOE_v3_1(HeteronuclNOE):
    ...
    def __init__(self, sf):
        ...
        self.add(key='EntityID',            tag_name='Entity_ID_1',             var_name='entity_ids',          missing=False)
        self.add(key='CompIndexID',         tag_name='Comp_index_ID_1',         var_name='res_nums',            missing=False)
        ...
        self.add(key='AtomIsotopeNumber',   tag_name='Atom_isotope_number_1',   var_name='isotope')
        ...
        self.add(key='EntityID2',           tag_name='Entity_ID_2',             var_name='entity_ids_2')
        self.add(key='CompIndexID2',        tag_name='Comp_index_ID_2',         var_name='res_nums_2')
        ...
        self.add(key='AtomIsotopeNumber2',  tag_name='Atom_isotope_number_2',   var_name='isotope_2')
        self.add(key='Val',                 tag_name='Val',                     var_name='data')
        self.add(key='ValErr',              tag_name='Val_err',                 var_name='errors')
