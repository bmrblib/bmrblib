...
class Rx(TagCategory):
    ...
    def __init__(self, sf):
        ...
        self.add(key='Val',                 tag_name=self.sf.name+'_value',                 var_name='data',                format='float')
        self.add(key='ValErr',              tag_name=self.sf.name+'_value_error',           var_name='errors',              format='float')
